        ...
        <div className="lg:col-span-2 bg-white rounded-xl shadow-sm border border-lab-accent p-6">
          ...
          <div className="mb-6">
            <div className="flex justify-between items-end mb-2">
              <span className="text-2xl font-bold text-lab-text">
                {printer.jobName}
              </span>
              <span className="text-3xl font-bold text-lab-primary">
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-lab-bg p-4 rounded-lg">
              ...
              <div className="text-xl font-semibold text-lab-text">
                {printer.elapsedTime || '-'}
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="font-mono font-medium">
                    {Math.round(printer.nozzleTemp)} / {printer.nozzleTarget}°C
                  </span>
                </div>
                <div className="w-full bg-gray-100 rounded-full h-1.5">
                  <div
                    className="bg-orange-400 h-1.5 rounded-full"
                    style={{ width: `${(printer.nozzleTemp / 300) * 100}%` }}
                  />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between text-sm mb-1">
                  ...
                  <span className="font-mono font-medium">
                    {Math.round(printer.bedTemp)} / {printer.bedTarget}°C
                  </span>
                </div>
                <div className="w-full bg-gray-100 rounded-full h-1.5">
                  <div
                    className="bg-blue-400 h-1.5 rounded-full"
                    style={{ width: `${(printer.bedTemp / 120) * 100}%` }}
                  />
                </div>
              </div>
            </div>
